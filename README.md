...
- 📎 **ไฟล์แนบในงาน** (รูป/ไฟล์) + 👤 **โปรไฟล์** แก้ชื่อ/อัปโหลดอวตาร/เปลี่ยนรหัส (Supabase Storage)
- 📊 **แดชบอร์ดสถิติ** — การ์ดสรุป + กราฟแยกตามสถานะ/ความสำคัญ/ภาระงานต่อสมาชิก + งานที่เสร็จย้อนหลัง 8 สัปดาห์
- 📲 **ติดตั้งเป็นแอป (PWA)** — เพิ่มลงหน้าจอ, ใช้แบบออฟไลน์ได้ + โครง Web Push (เปิดเมื่อตั้ง VAPID)
- 📱 **รองรับมือถือ** ทุกหน้า (บอร์ด/ตาราง/รายการ/ปฏิทิน มีเลย์เอาต์เฉพาะจอเล็ก)
